/**
 * ============================================================
 * ROUTE: PUT /hotspot/profile/:id/toggle-status
 * ============================================================
 *
 * Category  : Hotspot_Profile
 * Page      : Hotspot Profile
 * Key       : toggleStatus
 * Method    : PUT — UPDATE
 *
 * Description: Update / Replace existing data
 *
 * Generated  : 2026-05-16T19:49:10.120Z
    ...
    return Response.json(
      {
        ...
        endpoint: '/hotspot/profile/:id/toggle-status',
        method: 'PUT',
        category: 'Hotspot_Profile',
