/**
 * ============================================================
 * ROUTE: POST /hotspot/user/bulk-reset-counter
 * ============================================================
 *
 * Category  : Hotspot_User
 * Page      : Hotspot User
 * Key       : bulkResetCounter
 * Method    : POST — CREATE/SUBMIT
 *
 * Description: Create / Submit / Execute action
 *
 * Generated  : 2026-05-16T19:49:10.108Z
    ...
    return Response.json(
      {
        ...
        endpoint: '/hotspot/user/bulk-reset-counter',
        method: 'POST',
        category: 'Hotspot_User',
