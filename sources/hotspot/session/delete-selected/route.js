/**
 * ============================================================
 * ROUTE: DELETE /hotspot/session/delete-selected?_ids_=:ids
 * ============================================================
 *
 * Category  : Hotspot_Session
 * Page      : Hotspot Session
 * Key       : deleteSelected
 * Method    : DELETE — DELETE
 *
 * Description: Delete data
 *
 * Generated  : 2026-05-16T19:49:10.121Z
    ...
    return Response.json(
      {
        ...
        endpoint: '/hotspot/session/delete-selected?_ids_=:ids',
        method: 'DELETE',
        category: 'Hotspot_Session',
